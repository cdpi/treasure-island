...
import { feDisplacementMap, feMorphology, feTurbulence, svgElement } from "@cdpi/html.js";
function svgFilter() {
    /*
...
function water() {
    return svgElement("rect", { x: 0, y: 0, width: "100%", height: "100%", fill: "var(--water-color)" });
}
function create() {
    water();
    svgFilter();
